//
//  KnowledgeCompetitionLanguageCell.swift
//  Math-AI
//
...
class KnowledgeCompetitionLanguageCell: UICollectionViewCell {
    static let identifier = "KnowledgeCompetitionLanguageCell"
...
//MARK: - SetupUI
extension KnowledgeCompetitionLanguageCell {
    func setupUI() {
